...
export default function HomeGlacierDrawer(props: HomeGlacierDrawerProps) {
  ...
  return (
    <StyledDrawer anchor="right" open={isOpen} onClose={toggleDrawer(false)}>
      <div
        className={
          "pl-4 pr-4 col-span-6 md:grid-cols-5 md:-ml-4 md:pl-4 gap-4 mg-8 grid bg-[#fff] md:col-start-2 pointer-events-auto overflow-visible shadow-drawer lg:pr-8 lg:pt-[6.25rem] lg:pb-[6.25rem]"
        }
      >
        {children}
      </div>
